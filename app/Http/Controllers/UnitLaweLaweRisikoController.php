...
class UnitLaweLaweRisikoController extends Controller
{
    ...
    {
        if (auth()->user()->role !== 'unit_lawe_lawe') {
    ...
    public function index()
    {
        ...
        $alerts = DaftarRisiko::where('unit_nama', 'Unit Lawe-Lawe')
        ...
        return view('unit_lawe_lawe_risiko.daftar_risiko', compact('risiko', 'alerts'));
    }

    public function create()
    {
        $this->checkRole();
        return view('unit_lawe_lawe_risiko.tambah_risiko');
    }
    ...
    public function store(Request $request)
    {
        ...
        $risiko->unit_nama = 'Unit Lawe-Lawe';
        ...
        return redirect()
            ->route('unit_lawe_lawe.risiko.index')
    ...
    public function edit($id)
    {
        ...
        return view('unit_lawe_lawe_risiko.edit_risiko', compact('risiko'));
    }
