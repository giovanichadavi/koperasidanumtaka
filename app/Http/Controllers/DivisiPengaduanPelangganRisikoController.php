...
class DivisiPengaduanPelangganRisikoController extends Controller
{
    ...
    public function index()
    {
        ...
        $alerts = DaftarRisiko::where('unit_nama', 'Divisi Pengaduan Pelanggan')
        ...
        return view('divisi_pengaduan_pelanggan_risiko.daftar_risiko', compact('risiko', 'alerts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $risiko->unit_nama = 'Divisi Pengaduan Pelanggan';
