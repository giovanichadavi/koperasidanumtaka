...
class DivisiPenerbitRekeningRisikoController extends Controller
{
    ...
    public function index()
    {
        ...
        $alerts = DaftarRisiko::where('unit_nama', 'Divisi Penerbit Rekening')
        ...
        return view('divisi_penerbit_rekening_risiko.daftar_risiko', compact('risiko', 'alerts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $risiko->unit_nama = 'Divisi Penerbit Rekening';
