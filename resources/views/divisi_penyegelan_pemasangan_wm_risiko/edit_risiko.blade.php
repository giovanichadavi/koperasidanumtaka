...
@section('title', 'Edit Risiko | Penyegelan & Pemasangan WM')
...
<div class="card custom-card shadow-sm">
    ...
    <div class="card-header">
        <label class="mb-0 font-weight-semibold">
            Edit Daftar Risiko Divisi Penyegelan & Pemasangan WM
        </label>
    </div>
    ...
    <div class="card-body d-flex flex-column">
        ...
        <form method="POST"
              action="{{ route('divisi_penyegelan_pemasangan_wm.risiko.update', $risiko->id) }}"
            ...
            <div class="d-flex justify-content-end border-top pt-3 mt-auto">
                <a href="{{ route('divisi_penyegelan_pemasangan_wm.risiko.index') }}" class="btn btn-secondary">
                    Kembali
                </a>
