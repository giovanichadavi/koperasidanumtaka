...
@section('title', 'Tambah Risiko | Penyegelan & Pemasangan WM')
    ...
    <div class="card custom-card h-100 shadow-sm">
        ...
        <div class="card-header">
            <label class="mb-0 font-weight-semibold">
                Tambah Daftar Risiko Divisi Penyegelan & Pemasangan WM
            </label>
        </div>
        ...
        <div class="card-body d-flex flex-column">
            ...
            <form method="POST"
                  action="{{ route('divisi_penyegelan_pemasangan_wm.risiko.store') }}"
