...
class DivisiLaboratoriumRisikoController extends Controller
{
    private function checkRole()
    {
        if (auth()->user()->role !== 'divisi_laboratorium') {
    ...
    public function index()
    {
        ...
        $risiko = DaftarRisiko::where('unit_nama', 'Divisi Laboratorium')
        ->orderBy('created_at', 'desc')
                ->paginate(5);

        return view('divisi_laboratorium_risiko.daftar_risiko', compact('risiko'));
    }
    ...
    {
        $this->checkRole();
        return view('divisi_laboratorium_risiko.tambah_risiko');
    }
    ...
    public function store(Request $request)
{
    ...
    return redirect()
        ->route('divisi_laboratorium.risiko.index')
    ...
    public function edit($id)
    {
        ...
        return view('divisi_laboratorium_risiko.edit_risiko', compact('risiko'));
    }
