...
class DivisiPerencanaanAnggaranRisikoController extends Controller
{
    private function checkRole()
    {
        if (auth()->user()->role !== 'divisi_perencanaan_anggaran') {
    ...
    public function index()
    {
        ...
        $alerts = DaftarRisiko::where('unit_nama', 'Divisi Perencanaan Anggaran')
            ->whereNotNull('feedback_admin')
            ->where('feedback_admin', '!=', '')
            ->get();

        $risiko = DaftarRisiko::where('unit_nama', 'Divisi Perencanaan Anggaran')
            ->orderBy('created_at', 'desc')
            ->paginate(10);

        // Tambahkan 'alerts' ke dalam compact
        return view('divisi_perencanaan_anggaran_risiko.daftar_risiko', compact('risiko', 'alerts'));
    }

    public function create()
    {
        $this->checkRole();
        return view('divisi_perencanaan_anggaran_risiko.tambah_risiko');
    }
    ...
    public function store(Request $request)
    {
        ...
        $risiko->unit_nama = 'Divisi Perencanaan Anggaran';
        ...
        return redirect()
            ->route('divisi_perencanaan_anggaran.risiko.index')
    ...
    public function edit($id)
    {
        ...
        return view('divisi_perencanaan_anggaran_risiko.edit_risiko', compact('risiko'));
    }
