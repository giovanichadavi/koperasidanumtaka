...
@section('title', 'Edit Risiko | Unit Lawe-Lawe')
...
<div class="card custom-card shadow-sm">
    ...
    <div class="card-header">
        <label class="mb-0 font-weight-semibold">
            Edit Daftar Risiko Unit Lawe-lawe
        </label>
    </div>
    ...
    <div class="card-body d-flex flex-column">
        ...
        <form method="POST"
              action="{{ route('unit_lawe_lawe.risiko.update', $risiko->id) }}"
            ...
            <div class="d-flex justify-content-end border-top pt-3 mt-auto">
                <a href="{{ route('unit_lawe_lawe.risiko.index') }}" class="btn btn-secondary">
                    Kembali
                </a>
