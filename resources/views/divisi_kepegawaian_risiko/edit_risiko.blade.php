...
@section('title', 'Edit Risiko | Kepegawaian')
...
<div class="card custom-card shadow-sm">
    ...
    <div class="card-header">
        <label class="mb-0 font-weight-semibold">
            Edit Daftar Risiko Divisi Kepegawaian
        </label>
    </div>
    ...
    <div class="card-body d-flex flex-column">
        ...
        <form method="POST"
              action="{{ route('divisi_kepegawaian.risiko.update', $risiko->id) }}"
            ...
            <div class="d-flex justify-content-end border-top pt-3 mt-auto">
                <a href="{{ route('divisi_kepegawaian.risiko.index') }}" class="btn btn-secondary">
                    Kembali
                </a>
