    ...
    <div class="card-header text-center">
        <a href="{{ route('unit_waru.risiko.create') }}"
           class="btn btn-primary btn-sm float-right">
            <i class="fas fa-plus mr-1"></i> Tambah Risiko Unit Waru
        </a>
        <h5 class="mb-0 text-center">Laporan Daftar Risiko Unit Waru</h5>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-inline-flex align-items-center">
                                <a href="{{ route('unit_waru.risiko.edit', $r->id) }}"
                                   class="btn btn-warning btn-sm mr-2">
                                    <i class="fas fa-edit mr-1"></i> Edit
                                </a>

                                <form action="{{ route('unit_waru.risiko.destroy', $r->id) }}"
                                      method="POST"
                                      class="d-inline"
