...
<div class="card custom-card shadow-sm">
    ...
    <div class="card-body d-flex flex-column">
        ...
        <form method="POST"
              action="{{ route('divisi_tunggakan_rekening_air.risiko.update', $risiko->id) }}"
            ...
            <div class="d-flex justify-content-end border-top pt-3 mt-auto">
                <a href="{{ route('divisi_tunggakan_rekening_air.risiko.index') }}" class="btn btn-secondary">
                    Kembali
                </a>
