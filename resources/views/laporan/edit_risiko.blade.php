...
<div class="card custom-card shadow-sm">
    ...
    <div class="card-body d-flex flex-column">
        ...
        <form method="POST"
              action="{{ route('laporan.risiko.update', $risiko->id) }}"
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="checkbox" name="desain_a" value="1" {{ $risiko->desain_a ? 'checked' : '' }}></td>
                                    <td><input type="checkbox" name="desain_t" value="1" {{ $risiko->desain_t ? 'checked' : '' }}></td>
                                    <td><input type="checkbox" name="efektivitas_te" value="1" {{ $risiko->efektivitas_te ? 'checked' : '' }}></td>
                                    <td><input type="checkbox" name="efektivitas_ke" value="1" {{ $risiko->efektivitas_ke ? 'checked' : '' }}></td>
                                    <td><input type="checkbox" name="efektivitas_e" value="1" {{ $risiko->efektivitas_e ? 'checked' : '' }}></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                            ...
                            @foreach($jenisRisiko as $i => $jr)
                                <div class="col-sm-6 mb-2">
                                    <div class="custom-control custom-switch">
                                        ...
                                        <label class="custom-control-label" for="jr{{ $i }}">
                                            {{ $jr }}
                                        </label>
                                    </div>
                                </div>
            ...
            <div class="d-flex justify-content-end border-top pt-3 mt-auto">
                <a href="{{ route('laporan.daftar_risiko.index') }}" class="btn btn-secondary">
                    Kembali
                </a>
