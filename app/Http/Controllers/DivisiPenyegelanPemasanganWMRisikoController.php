...
class DivisiPenyegelanPemasanganWMRisikoController extends Controller
{
    ...
    public function index()
    {
        ...
        $alerts = DaftarRisiko::where('unit_nama', 'Divisi Penyegelan & Pemasangan WM')
        ...
        return view('divisi_penyegelan_pemasangan_wm_risiko.daftar_risiko', compact('risiko', 'alerts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $risiko->unit_nama = 'Divisi Penyegelan & Pemasangan WM';
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('divisi.penyegelan_pemasangan_wm.risiko.index')
