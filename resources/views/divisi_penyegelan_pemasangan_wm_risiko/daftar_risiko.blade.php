...
@section('title', 'Laporan Daftar Risiko | Penyegelan & Pemasangan WM')
...
<div class="card mt-2 shadow-sm">
    <div class="card-header py-3 border-0 d-flex align-items-center">
        <h5 class="mb-0 flex-grow-1 text-center font-weight-bold text-uppercase">Laporan Daftar Risiko Divisi Penyegelan & Pemasangan WM</h5>
        <a href="{{ route('divisi_penyegelan_pemasangan_wm.risiko.create') }}" class="btn btn-primary btn-sm shadow-sm">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="action-container">
                                <form action="{{ route('divisi_penyegelan_pemasangan_wm.risiko.destroy', $r->id) }}" method="POST" onsubmit="return confirm('Hapus data ini?')" class="form-inline-action">
                                    @csrf @method('DELETE')
                                ...
                                <a href="{{ route('divisi_penyegelan_pemasangan_wm.risiko.edit', $r->id) }}" class="btn btn-warning btn-action shadow-sm">
