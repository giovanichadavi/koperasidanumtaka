    ...
    <div class="card-header text-center">
        <a href="{{ route('divisi_penyegelan_pemasangan_wm.risiko.create') }}"
           class="btn btn-primary btn-sm float-right">
            <i class="fas fa-plus mr-1"></i> Tambah Risiko Divisi Pengaduan Pelanggan
        </a>
        <h5 class="mb-0 text-center">Laporan Daftar Risiko Divisi Pengaduan Pelanggan</h5>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-inline-flex align-items-center">
                                <a href="{{ route('divisi_pengaduan_pelanggan.risiko.edit', $r->id) }}"
                                   class="btn btn-warning btn-sm mr-2">
                                    <i class="fas fa-edit mr-1"></i> Edit
                                </a>

                                <form action="{{ route('divisi_pengaduan_pelanggan.risiko.destroy', $r->id) }}"
                                      method="POST"
                                      class="d-inline"
