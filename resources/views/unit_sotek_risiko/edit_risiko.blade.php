...
@section('title', 'Edit Risiko | Unit Sotek')
...
<div class="card custom-card shadow-sm">
    ...
    <div class="card-body d-flex flex-column">
        ...
        <form method="POST"
              action="{{ route('unit_sotek.risiko.update', $risiko->id) }}"
            ...
            <div class="d-flex justify-content-end border-top pt-3 mt-auto">
                <a href="{{ route('unit_sotek.risiko.index') }}" class="btn btn-secondary">
                    Kembali
                </a>
