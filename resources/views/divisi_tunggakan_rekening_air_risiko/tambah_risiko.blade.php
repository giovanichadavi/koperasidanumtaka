...
@section('title', 'Tambah Risiko | TRA')
    ...
    <div class="card custom-card h-100 shadow-sm">
        ...
        <div class="card-header">
            <label class="mb-0 font-weight-semibold">
                Tambah Daftar Risiko Divisi TRA
            </label>
        </div>
        ...
        <div class="card-body d-flex flex-column">
            ...
            <form method="POST"
                  action="{{ route('divisi_tunggakan_rekening_air.risiko.store') }}"
    ...
    <div class="row">
        ...
        @endforeach
                ...
                <div class="d-flex justify-content-end border-top pt-3 mt-auto">
                    <a href="{{ route('divisi_kas_penagihan.risiko.index') }}"
...
@endpush@extends('adminlte::page')

@section('title', 'Tambah Risiko | Kas & Penagihan')
...
<div class="container-fluid pt-4">
    <div class="card custom-card h-100 shadow-sm">
        ...
        <div class="card-header">
            <label class="mb-0 font-weight-semibold">
                Tambah Daftar Risiko Divisi Kas & Penagihan
            </label>
        </div>
...
<div class="form-group mb-4">
    ...
    <div class="row">
        ...
        @endforeach
                ...
                {{-- FOOTER --}}
                <div class="d-flex justify-content-end border-top pt-3 mt-auto">
                    <a href="{{ route('divisi_tunggakan_rekening_air.risiko.index') }}"
                       class="btn btn-secondary">
                        Kembali
                    </a>
                    <button class="btn btn-primary ml-2">
